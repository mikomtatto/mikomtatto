...
const GalleryDetail = () => {
  ...
  const handleSubmitComment = async (e) => {
    ...
    const storageKey = `commented_galleryimage_${id}`
    ...
    <section className="pt-32 sm:pt-36 md:pt-40 pb-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            {image.is_featured && (
              <div className="inline-flex items-center gap-2 bg-accent text-black px-3 py-1 rounded-full text-xs font-bold mb-4">
            ...
            <div className="text-gray-500 text-sm">
              <p>Oluşturulma Tarihi: {new Date(image.created_at).toLocaleDateString('tr-TR')}</p>
            </div>
          </div>
        </div>
