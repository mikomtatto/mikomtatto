...
useEffect(() => {
  ...
  return (
    <section ref={sectionRef} id="styles" className={`py-16 sm:py-20 md:py-24 px-4 bg-gradient-to-b from-dark to-darker transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
