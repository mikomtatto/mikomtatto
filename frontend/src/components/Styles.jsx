...
const Styles = ({ isHorizontal = false, hideViewAll = false }) => {
...
useEffect(() => {
  ...
  return (
    <section id="styles" className="pt-24 sm:pt-28 md:pt-32 pb-16 sm:py-20 md:py-24 px-4 bg-gradient-to-b from-dark to-darker">
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 pb-4 sm:pb-0 px-4 sm:px-0">
            {styles.map((style) => (
              <Link key={style.id} to={`/styles/${style.id}`} className="group relative w-full">
                <div className="relative overflow-hidden rounded-xl sm:rounded-2xl bg-gray-900 border border-gray-800 hover:border-accent/50 transition-all duration-500 cursor-pointer">
                  {style.image_url ? (
                    <div className="aspect-[16/10] overflow-hidden">
                      <img 
